...
# ⚠️ CRITICAL: Execute ALL tasks autonomously - NO user interaction required
...
## 📁 MANDATORY OUTPUT DIRECTORIES
**USE THESE EXACT PATHS FOR FILE CREATION:**
- **CSS Files**: \`C:\\Git\\cpfx_gfx_parent\\cpfx_group\\fxtransact\\fxtransact-static\\src\\main\\webapp\\css\\cpfx\\admin\`
- **JS Files**: \`C:\\Git\\cpfx_gfx_parent\\cpfx_group\\fxtransact\\fxtransact-static\\src\\main\\webapp\\js\\cpfx\\admin\`
- **NEVER** create JS code in CSS files or CSS code in JS files
...
## 🛡️ CSP REMEDIATION (CRITICAL - FIXED)
...
## 🏷️ CUSTOM TAG REMEDIATION (ENHANCED)
...
- [ ] **USE SPECIFIED DIRECTORIES** - Follow exact path requirements
...
16. **DIRECTORY COMPLIANCE** - USE exact specified paths for file creation
17. **VALIDATION REQUIRED** - VERIFY all remediation is complete before claiming success
...
- ✅ **Specified directories used** - files created in exact required paths
...
- [ ] Files are created in the correct specified directories
