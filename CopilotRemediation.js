...
# Content Security Policy (CSP) implementation, and parallel vulnerability remediation.
# Your task is to clone the specified repository, perform comprehensive file-by-file analysis,
# and remediate security vulnerabilities in parallel across all files simultaneously.
#
# CRITICAL REQUIREMENTS:
# ======================
# 1. REPOSITORY CLONING: Clone the repository from the provided URL
# 2. PARALLEL FILE ANALYSIS: Analyze all files simultaneously for security issues
# 3. FILE-BY-FILE REMEDIATION: Fix vulnerabilities in each file individually
# 4. PARALLEL PROCESSING: Process multiple files concurrently for efficiency
# 5. PRODUCTION-READY: Generate enterprise-grade security fixes for each file
# 6. INDIVIDUAL FILE DOCUMENTATION: Provide detailed fixes for each file
#
# REPOSITORY CLONING AND IN-PLACE REMEDIATION INSTRUCTIONS:
# ==========================================================
# 1. Clone the repository: git clone ${repoUrl}
# 2. Navigate to the repository directory
# 3. Scan all files in the repository for security vulnerabilities
# 4. Identify vulnerable files by type:
...
# 5. DIRECTLY REMEDIATE each vulnerable file in-place within the cloned repository
# 6. Update the actual source files with security fixes
# 7. Test each remediated file to ensure functionality is preserved
...
#
# IN-PLACE FILE MODIFICATION PROCESS:
# ===================================
# For each vulnerable file, perform the following steps:
# 1. Identify specific security vulnerabilities in the file
# 2. Apply security fixes directly to the source file
# 3. Test the modified file to ensure functionality is preserved
# 4. Document the changes made in the remediation log
# 5. Verify security improvements are effective
#
# DIRECT FILE REMEDIATION WORKFLOW:
# =================================
# 1. Clone repository and navigate to directory
# 2. Modify HTML files directly (add CSP headers, fix XSS, remove inline scripts)
# 3. Modify CSS files directly (remove inline styles, fix security issues)
# 4. Modify JavaScript files directly (remove inline scripts, replace eval(), fix XSS)
# 5. Modify backend files directly (add input validation, fix injection vulnerabilities)
# 6. Modify configuration files directly (add security headers, secure settings)
# 7. Test all modified files to ensure they work correctly
# 8. Create remediation log documenting all changes
# 9. Verify security improvements are effective
#
# Please clone the repository, perform comprehensive security analysis, and directly remediate
# vulnerable files in-place within the cloned repository. Apply security fixes directly to the 
# source files, test each modified file, and create a remediation log documenting all changes. 
# Ensure all fixes follow enterprise security standards and preserve application functionality.`;
