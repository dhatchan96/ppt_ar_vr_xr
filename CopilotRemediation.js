  ...
  const filterVulnerabilities = (vulns, searchFilter, severityFilter, aitFilter) => {
    return vulns.filter(vuln => {
      const matchesSearch = !searchFilter || 
        vuln.id?.toLowerCase().includes(searchFilter.toLowerCase()) ||
        vuln.gis_id?.toLowerCase().includes(searchFilter.toLowerCase()) ||
        vuln.title?.toLowerCase().includes(searchFilter.toLowerCase()) ||
        vuln.description?.toLowerCase().includes(searchFilter.toLowerCase()) ||
        vuln.remediation_action?.toLowerCase().includes(searchFilter.toLowerCase());
